...
class CVSMNet_SoftArgMin_trilinear(nn.Module):
    def __init__(self, maxdisp):
        super(CVSMNet_SoftArgMin_trilinear, self).__init__()
    ...
    def disparity_regression(self, input, height, width):
        ...
        cost = F.upsample(cost, [self.maxdisp, height, width], mode="trilinear")
