...
class CVSMNet_SoftArgMin_3DUNetAll(nn.Module):
    def __init__(self, maxdisp):
        super(CVSMNet_SoftArgMin_3DUNetAll, self).__init__()
        self.maxdisp = maxdisp
        self.feature_extraction = feature_extraction()
        self.maxPool3d = nn.MaxPool3d(3, stride=(2,2,2),padding =(1,1,1))
        self.upsample3d = nn.Upsample(scale_factor=(2,2,2), mode='nearest')
